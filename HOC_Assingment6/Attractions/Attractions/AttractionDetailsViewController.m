...
- (IBAction) activityButtonTouched:(id)sender
{
  ...
  activityActionSheet = [[UIActionSheet alloc] initWithTitle:nil delegate:self cancelButtonTitle:@"Cancel" destructiveButtonTitle:nil otherButtonTitles:@"Email", @"Share", nil];
...
- (void) actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex
{
  ...
  if (actionSheet.tag == AttractionDetailsActionSheetTagActivity)
  {
    ...
    /*else if (buttonIndex == AttractionDetailsActivityButtonIndexMessage)
       {
        NSLog(@"Message button index");
        [self messageAttractionInfo];
       }*/
